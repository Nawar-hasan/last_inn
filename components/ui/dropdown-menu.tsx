  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "relative flex cursor-pointer items-center gap-2 rounded-md px-2 py-2",
        "text-sm outline-hidden select-none transition-colors",
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn("px-2 py-2 text-sm font-semibold data-[inset]:pl-8", className)}
      {...props}
    />
  )
}
